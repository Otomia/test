...
void Copy_1(BinTreeNode *bt1, BinTreeNode **bt2);
...
BinTreeNode* CreateBinTree_VLR_LVR_1(char *vlr, char *lvr, int n)
{
	...
	t->rightChild = CreateBinTree_VLR_LVR_1(vlr + k + 1, lvr + k + 1, n - k);
	return t;
}
...
bool Equal_1(BinTreeNode *t1, BinTreeNode *t2)
{
	...
	if (t1 != NULL && t2 != NULL
		&& t1->data == t2->data
		&& Equal_1(t1->leftChild, t2->rightChild)
